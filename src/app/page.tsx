      ...
      <section className={styles.hero}>
        <div className="container">
          <div className={styles.hero_container}>
            <h1>Ремонт и строительство “под ключ” без задержек по всей РБ. Гарантия от 2-х лет</h1>
            <div>Фиксированные сроки и стоимость, специалисты с опытом &gt; 8 лет. Работаем по ТКП, СН и СТБ ISO 9001</div>
      ...
      <section className={styles.short}>
        <div className="container">
          <div className={styles.short_container}>
            <Short
              title="90%"
              description="объектов сданы в срок"
            />
            <Short
              title="1 день"
              description="расчет сметы"
            />
            <Short
              description="Реализуем любые идеи и проекты"
            />
            <Short
              description="Начнём работу уже завтра"
            />
          </div>
        </div>
      </section>
      ...
      <section className={styles.services}>
        <div className="container">
          <div className={styles.services_container}>
              <h2>Услуги</h2>
              <div className={styles.text}>Мы берем на себя весь процесс - от замера до сдачи объекта, обеспечивая результат <span>от 30 до 90 дней</span>, в зависимости от объема работ. Работаем с частными и коммерческими объектами по фиксированной договорной цене и гарантией от 2-х лет</div>
      ...
      <section className={styles.projects}>
        <div className="container">
          <div className={styles.projects_container}>
              <h2>Проекты</h2>
              <div className={styles.text}>Создаем комфортное пространство, в котором хочется жить и работать. Мы успешно завершили &gt;150 проектов по Беларуси, 98% из них сданы без задержек.</div>
              ...
              <div className={styles.short_project}>
                <div>Каждый проект - это продуманные решения, проверенные технологии и команда с опытом &gt; 8 лет. Хотите качественный результат? Доверьте работу профессионалам!</div>
